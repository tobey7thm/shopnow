        ...
        <div class="container">
          <div class="row clearfix">
            ...
            <div class="col-lg-9 col-md-9 col-sm-9 m_xs_bottom_30">
                    ...
                    <form name="input" method="post"  enctype="multipart/form-data" action="qiugou_xiugai_save.php" onsubmit=return(CheckInput())>
                      <ul>
                        <li class="m_bottom_15">
                          <label for="title" class="d_inline_b m_bottom_5 required">标题</label>
                          <input type="text" id="title" name="title" class="r_corners full_width" value="<?php echo $data[title];?>">
                        </li>
                        <li class="m_bottom_15">
                          <label for="comments" class="d_inline_b m_bottom_5 required">内容</label><br>
                    <textarea id="comments" name="comments" class="r_corners full_width"><?php echo $data[content];?></textarea>
                        </li>
                        <li class="m_bottom_15">
                          <label for="address" class="d_inline_b m_bottom_5">联系地址</label>
                          <input type="text" id="address" name="address" class="r_corners full_width" value="<?php echo $data[address];?>">
                        </li>
                        <li class="m_bottom_15">
                          <label for="tel" class="d_inline_b m_bottom_5 required">联系电话</label>
                          <input type="text" id="tel" name="tel" class="r_corners full_width" value="<?php echo $data[tel];?>">
                        </li>
                        <li class="m_bottom_15">
                          <label for="qq" class="d_inline_b m_bottom_5">联系qq</label>
                          <input type="text" id="qq" name="qq" class="r_corners full_width" value="<?php echo $data[qq];?>">
                        </li>
                        <li class="m_bottom_15">
                      ...
                      <li class="m_right_5 m_sm_bottom_5"><input name="id" type="hidden" id="id" value="<?php echo $data[id];?>"><button type="reset" name="Submit2" class="tr_delay_hover r_corners button_type_4 color_dark bg_light_color_2 f_size_large">重置</button></li>
                      <li class="m_right_5 m_sm_bottom_5"><button type="submit" name="Submit" class="button_type_4 r_corners bg_scheme_color color_light tr_all_hover">提交</button></li>
                       </ul>
                      </ul>
                    </form>
                  </div>
