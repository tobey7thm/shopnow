...
function CheckInput(){
  ...
  return true;
      ...
      <section class="breadcrumbs">
        <div class="container">
          <ul class="horizontal_list clearfix bc_list f_size_medium">
            ...
            <li><a href="" class="default_t_color">发布商品</a></li>
          </ul>
        </div>
      </section>
      <!--content-->
        ...
        <div class="container">
          <div class="row clearfix">
            ...
            <div class="col-lg-9 col-md-9 col-sm-9 m_xs_bottom_30">
                    <h5 class="fw_medium m_bottom_15">请填写商品信息</h5>
                    <form name="input" method="post"  enctype="multipart/form-data" action="sell_save.php" onsubmit=return(CheckInput())>
                      <ul>
                        <li class="m_bottom_15">
                          <label for="title" class="d_inline_b m_bottom_5 required">商品名称</label>
                          <input type="text" id="title" name="title" class="r_corners full_width">
                        </li>
                        <li class="m_bottom_15">
                          <label class="d_inline_b m_bottom_5">商品种类</label>
                          <!--product name select-->
                          
                            <select name="select" id="select">
                               <?php
    $sql="select * from cat where reid>0 order by id";
    ...
    ?>
                        ...
                        <li class="m_bottom_15">
                          <label for="comments" class="d_inline_b m_bottom_5 required">商品描述</label><br>
                    <textarea id="comments" name="comments" class="r_corners full_width"></textarea>
                        </li>
                        <li class="m_bottom_15">
                          <label for="num" class="d_inline_b m_bottom_5 required">商品数量</label>
                          <input type="text" id="num" name="num" class="r_corners full_width">
                        </li>
                        <li class="m_bottom_15">
                        ...
                        <li class="m_bottom_15">
                          <label for="price" class="d_inline_b m_bottom_5 required">商品价格</label>
                          <input type="text" id="price" name="price" class="r_corners full_width">
                        </li>
                        <li class="m_bottom_15">
                          <label for="pic" class="d_inline_b m_bottom_5">商品图片</label>
                          <input type="file" id="pic" name="pic" class="r_corners full_width">
                        </li>
